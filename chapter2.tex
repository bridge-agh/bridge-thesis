...
w~formularzu podać dane wykorzystanie podczas rejestracji (Rys.~\ref{fig:schemat_login}).
...
i~udostępnić, np. znajomym, aby mogli oni do niego dołączyć (Rys.~\ref{fig:schemat_create_lobby}).
...
dołączyć do przypisanego do kodu lobby (Rys.~\ref{fig:schemat_join_lobby}).
