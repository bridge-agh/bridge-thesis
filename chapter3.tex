...
Główne funkcje asystenta AI wykorzystują informację o najlepszych ruchach
...
Obserwacja w~brydżu kodowana jest jako wektor jednowymiarowy.
...
W~procesie uczenia zaobserwował 110,886,912 ruchów,
...
ewaluacja nie wybiera zawsze optymalnego ruchu,
...
\begin{figure}[h]
  ...
  \caption{Proces uczenia AlphaZero vs. losowy gracz}
