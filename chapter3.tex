...
Sieć $\mathbf{p}$ uczona jest poprzez minimalizację funkcji kosztu,
...
algorytm zbiega się do rozwiązania MiniMax, czyli stanu równowagi Nasha.
Można zatem wnioskować, że sieć $\mathbf{p}$ również zbiega się
...
sieć zbiega się do stanu równowagi Nasha.
To rozumowanie nie jest formalnie poprawne dla gier z~niepełną informacją.
W~praktyce to rozwiązanie daje zadowalające wyniki, mimo braku zbieżności
do stanu równowagi Nasha.
Dokładniejsza analiza przedstawiona jest w Appendix. % TODO

Można więc wykorzystać samą sieć, bez MCTS, do wyboru ruchu.
