...
\cite{ThreeJS} (Rys.~\ref{fig:engine_orbit}).
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{img/bridge-engine/orbit.png}
  \caption{Widok boczny z~trójwymiarowej przestrzeni silnika gry.}
