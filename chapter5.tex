...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{img/schematy/strategic_plan.png}
...
\begin{figure}[h!]
  ...
  \caption{Strona lobby z perspektywy hosta}
  \label{fig:lobby}
\end{figure}
...
\subsubsection{Wybór poziomu wirtualnego asystenta}

Host ma możliwość z widoku lobby przejść do ustawień poziomu zaawansowania 
wirtualnego asystenta (Rys. \ref{fig:set_ai_level}). Może ustawić poziom poprzez 
naciśnięcie od jednej do pięciu gwiazdek. Im mniejszy poziom, tym większa 
szansa na wykonanie przez asystenta nieoptymalnego ruchu. Wybrany poziom 
zaawansowania jest wspólny dla wszystkich asystentów w~lobby.

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{img/widoki/set_ai_level.png}
  \caption{Strona ustawień poziomu wirtualnego asystenta}
  \label{fig:set_ai_level}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{img/widoki/mobile_desktop.png}
...
Możliwe jest podniesienie umiejętności asystenta poprzez
